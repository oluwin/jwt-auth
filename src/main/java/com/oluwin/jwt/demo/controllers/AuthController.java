 ...
 */
package com.oluwin.jwt.demo.controllers;

import com.oluwin.jwt.demo.models.ERole;
import com.oluwin.jwt.demo.models.Role;
import com.oluwin.jwt.demo.models.User;
import com.oluwin.jwt.demo.payload.request.LoginRequest;
import com.oluwin.jwt.demo.payload.request.SignupRequest;
import com.oluwin.jwt.demo.payload.response.JwtResponse;
import com.oluwin.jwt.demo.payload.response.MessageResponse;
import com.oluwin.jwt.demo.repository.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        return ResponseEntity.ok(new MessageResponse("User "
                + signUpRequest.getUsername() + ", registered successfully!",1));
    }
}
